...
void ABeatCell::SetLength(float p_Length) {
	...
	l_Vertices.Add(FVector(0, p_Length * 100, 0));
	l_Vertices.Add(FVector(100, p_Length * 100, 0));
	l_Vertices.Add(FVector(100, 0, 0));
	...
	Beats->SetRelativeScale3D(FVector(1, GetConfig()->MappingGridScale, 1));
}