...
DECLARE_DYNAMIC_MULTICAST_DELEGATE(FOnMapCellsFinished);
...
class MMA3_API UMapDetailsWidget : public UUserWidget
{
	...
	UFUNCTION()
		void EventFloatSliderChanged(float ign);

	UFUNCTION()
	void EventTextBoxChanged(const FText& text);
...
public:
	...
	//UPROPERTY(VisibleAnywhere, Category = "Map Data")
		FMapInfo* Info;
...
////////////////////////////////////////////////////////////////
	...
	UPROPERTY(BlueprintAssignable)
		FOnMapCellsFinished OnMapCellsFinished;
