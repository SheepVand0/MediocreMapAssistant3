...
public:
	...
	static FSlateBrush GetUIElementStyle(FSlateBrush p_SlateBrush, float p_Size, FColor p_Color, FMargin p_Margin) {
		...
		p_SlateBrush.DrawAs = ESlateBrushDrawType::RoundedBox;
		p_SlateBrush.TintColor = p_Color;
		p_SlateBrush.Margin = p_Margin;
		p_SlateBrush.OutlineSettings.CornerRadii = FVector4(5, 5, 5, 5);
		p_SlateBrush.OutlineSettings.RoundingType = ESlateBrushRoundingType::FixedRadius;
		p_SlateBrush.OutlineSettings.Color = FSlateColor(FLinearColor(0.2, 0.2, 0.2, 0.5));
		p_SlateBrush.OutlineSettings.Width = 1;
		return p_SlateBrush;
	}
